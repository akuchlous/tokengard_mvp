...
class TestAPIKeyModel:
    ...
    def test_api_key_state_management(self, app):
    ...
    def test_api_key_refresh(self, app):
...
class TestDefaultAPIKeyCreation:
    ...
    def test_create_default_api_key(self, app):
        ...
        with app.app_context():
            ...
            api_key = create_default_api_key(user.id)
            ...
            db_key = APIKey.query.filter_by(user_id=user.id, key_name='test_key').first()
            assert db_key is not None
            assert db_key.key_value == api_key.key_value
    
    def test_default_api_key_uniqueness(self, app):
...
class TestAPIKeyValidation:
    ...
    def test_api_key_name_length_validation(self, app):
        ...
        with app.app_context():
            ...
            db.session.add(invalid_key_short)
            ...
            db.session.add(invalid_key_long)
            db.session.commit()
    
    def test_api_key_value_format_validation(self, app):
        ...
        with app.app_context():
            ...
            db.session.add(invalid_key_no_prefix)
            db.session.commit()
            ...
            db.session.add(invalid_key_wrong_length)
            db.session.commit()
...
class TestAPIKeySecurity:
    ...
    def test_api_key_user_isolation(self, app):
    ...
    def test_api_key_state_persistence(self, app):
